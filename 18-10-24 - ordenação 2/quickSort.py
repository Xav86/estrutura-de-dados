...
listaReOrdenada = quickSort(random_numbers, 0, 999)
...
listaReOrdenadaNomes = quickSort(names, 0, 199)

print(listaReOrdenadaNomes)


arrayDoExercicio3 = [8, 6, 4, 2, 0]

quickSort(arrayDoExercicio3, 0, len(arrayDoExercicio3) - 1)
